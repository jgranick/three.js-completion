...
Example = function(p) { if( p === $_ ) return; {
	this.renderer = new three.CanvasRenderer();
	this.scene = new three.Scene();
	this.camera = new three.Camera(50,800 / 600,1,10000);
	this.cube = this.createCube();
	this.renderer.setSize(800,600);
	this.camera.position.z = 700;
	this.cube.position.z = 200;
	this.scene.addObject(this.cube);
	js.Lib.document.body.appendChild(this.renderer.domElement);
	this.render();
}}
...
Example.prototype.cube = null;
Example.prototype.renderer = null;
Example.prototype.scene = null;
Example.prototype.createCube = function() {
	var materials = new Array();
	var colorMaterial = new three.MeshBasicMaterial();
	colorMaterial.color = new three.Color(16777215 * Math.random());
	var lineMaterial = new three.MeshBasicMaterial();
	lineMaterial.color = new three.Color(4473924);
